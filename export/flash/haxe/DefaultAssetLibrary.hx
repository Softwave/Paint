...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/menu.pxi", __ASSET__assets_images_menu_pxi);
		type.set ("assets/images/menu.pxi", AssetType.BINARY);
		className.set ("assets/music/music-goes-here.txt", __ASSET__assets_music_music_goes_here_txt);
		type.set ("assets/music/music-goes-here.txt", AssetType.TEXT);
		className.set ("assets/shaders/Col.pbj", __ASSET__assets_shaders_col_pbj);
		type.set ("assets/shaders/Col.pbj", AssetType.BINARY);
...
@:keep @:bind #if display private #end class __ASSET__assets_shaders_col_pbj extends flash.utils.ByteArray { }
...
@:file("assets/shaders/Col.pbj") #if display private #end class __ASSET__assets_shaders_col_pbj extends lime.utils.ByteArray {}
